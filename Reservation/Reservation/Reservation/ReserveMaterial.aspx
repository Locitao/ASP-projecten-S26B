<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReserveMaterial.aspx.cs" Inherits="Reservation.ReserveMaterial" %>
...
<body>
    ...
    <div id="materials">
        ...
        <asp:ListBox ID="lbMaterials" runat="server" Height="156px" Width="275px"></asp:ListBox>
    </div>
    </form>
</body>
</html>
